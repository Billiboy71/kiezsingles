            ...
            <div class="flex gap-2.5 items-stretch flex-wrap mb-2.5">
                ...
                <div class="<?php echo e($creatorRoleUi['box']); ?> border rounded-xl px-2 py-1.5 min-w-[96px] flex-1 basis-[96px] text-center">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($creatorProfileUrl !== ''): ?>
                        <a href="<?php echo e($creatorProfileUrl); ?>" target="_self" class="block text-slate-900 font-extrabold underline leading-tight"><?php echo e($creatorDisplay); ?></a>
                    <?php else: ?>
                        <span class="block text-slate-900 font-extrabold leading-tight"><?php echo e($creatorDisplay); ?></span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <div class="mt-0.5 text-xs text-slate-700 leading-tight"><?php echo e($creatorRoleUi['label']); ?></div>
                </div>
            ...
            <form id="js-reply-form" method="POST" action="<?php echo e(route('admin.tickets.reply', $ticketId)); ?>">
                ...
                <div class="flex justify-end mt-2.5">
                    <div class="flex gap-2.5">
                        ...
                        <button id="js-reply-submit" type="submit" class="ks-btn" formaction="<?php echo e(route('admin.tickets.reply', $ticketId)); ?>" formmethod="POST">Absenden</button>
                ...
                <div class="border border-slate-200 rounded-xl p-3 bg-white mb-2.5">
                    <div class="flex justify-between gap-2.5 flex-wrap mb-1.5">
                        <div class="flex items-center gap-2 flex-wrap">
                            <span class="inline-flex flex-col items-center justify-center px-3 py-1 rounded-full text-xs font-black border text-center leading-tight <?php echo e($actorRoleClass); ?>">
                                <span class="block"><?php echo e($who); ?></span>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($actorRoleLabel !== ''): ?>
                                    <span class="block text-[11px] font-black opacity-95">(<?php echo e($actorRoleLabel); ?>)</span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </span>
