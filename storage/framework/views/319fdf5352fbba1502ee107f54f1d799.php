    ...
    >
        ...
        <div class="ks-row mb-3">
            ...
            <label class="ks-toggle ml-auto">
                <input type="checkbox" id="maintenance_enabled" name="maintenance_enabled" value="1" form="ks_maintenance_noscript_settings_form" <?php if($maintenanceEnabled): echo 'checked'; endif; ?> <?php echo $maintenanceDisabled; ?>>
        ...
        <div class="ks-row mb-3">
            ...
            <label class="ks-toggle ml-auto">
                <input type="checkbox" id="maintenance_show_eta" name="maintenance_show_eta" value="1" form="ks_maintenance_noscript_eta_form" <?php if($maintenanceShowEta): echo 'checked'; endif; ?> <?php echo $maintenanceDisabled; ?>>
                <span class="ks-slider"></span>
            </label>
        </div>
        ...
        <noscript>
            <div class="mt-4 pt-4 border-t border-gray-200 flex gap-2 flex-wrap">
                ...
                <form id="ks_maintenance_noscript_eta_form" method="POST" action="<?php echo e(route('admin.maintenance.eta')); ?>" class="m-0">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="maintenance_show_eta" value="0">
                    <button type="submit" class="px-[12px] py-[10px] rounded-[10px] border border-gray-900 bg-gray-900 text-white cursor-pointer">
