...
Changed: 18-02-2026 20:35 (Europe/Berlin)
Version: 1.3
============================================================================ --}}
...
@section('content')
    ...
    >
        ...
        {{-- Styles (Rest: an alte UI angelehnt; ks-row/label/info/toggle liegen jetzt zentral in admin.css) --}}
        <style>
        ...
        <div class="ks-row" style="margin:0 0 12px 0;">
            ...
            <label class="ks-toggle" style="margin-left:auto;">
                <input type="checkbox" id="maintenance_enabled" value="1" @checked($maintenanceEnabled) {!! $maintenanceDisabled !!}>
        ...
        <div class="ks-row" style="margin:0 0 12px 0;">
            ...
            <label class="ks-toggle" style="margin-left:auto;">
                <input type="checkbox" id="maintenance_show_eta" value="1" @checked($maintenanceShowEta) {!! $maintenanceDisabled !!}>
                <span class="ks-slider"></span>
            </label>
        </div>
        ...
        <div style="display:flex; gap:10px; flex-wrap:wrap; margin:0 0 10px 0; align-items:center;">
            <input type="date" id="maintenance_eta_date" value="{{ $etaDateValue }}"
                   style="padding:10px 12px; border:1px solid #ccc; border-radius:10px; width:170px;" {!! $maintenanceDisabled !!}>
            <input type="time" id="maintenance_eta_time" value="{{ $etaTimeValue }}"
                   style="padding:10px 12px; border:1px solid #ccc; border-radius:10px; width:120px;" {!! $maintenanceDisabled !!}>
            <button type="button" id="maintenance_eta_clear" class="ks-mini-btn" title="Zurücksetzen" {!! $maintenanceDisabled !!}>
        ...
        <div class="ks-row" style="margin:0 0 12px 0;">
            ...
            <label class="ks-toggle" style="margin-left:auto;">
                <input type="checkbox" id="maintenance_notify_enabled" value="1" @checked($maintenanceNotifyEnabled) {!! $systemSettingsDisabled !!}>
                <span class="ks-slider"></span>
            </label>
        </div>
        ...
        <div class="ks-row" style="margin:0 0 12px 0;">
            ...
            <label class="ks-toggle" style="margin-left:auto;">
                <input type="checkbox" id="maintenance_allow_admins" value="1" @checked($maintenanceAllowAdmins) {!! $systemSettingsDisabled !!}>
                <span class="ks-slider"></span>
            </label>
        </div>
        ...
        <div class="ks-row" style="margin:0 0 12px 0;">
            ...
            <label class="ks-toggle" style="margin-left:auto;">
                <input type="checkbox" id="maintenance_allow_moderators" value="1" @checked($maintenanceAllowModerators) {!! $systemSettingsDisabled !!}>
                <span class="ks-slider"></span>
            </label>
        </div>
        ...
        @if(!$isProd)
            <div class="ks-row" style="margin:0 0 12px 0;">
                ...
                <label class="ks-toggle" style="margin-left:auto;">
                    <input type="checkbox" id="debug_simulate_production" value="1" @checked($simulateProd) {!! $systemSettingsDisabled !!}>
                    <span class="ks-slider"></span>
                </label>
            </div>
        @endif
        ...
        <div class="ks-row" style="margin:0 0 12px 0;">
            ...
            <label class="ks-toggle" style="margin-left:auto;">
                <input type="checkbox" id="debug_break_glass" value="1" @checked($breakGlassEnabled) {!! $systemSettingsDisabled !!}>
                <span class="ks-slider"></span>
            </label>
        </div>
        ...
        <div style="display:flex; align-items:center; gap:10px; flex-wrap:wrap; margin-top:0;">
            <input type="number" id="debug_break_glass_ttl_minutes" min="1" max="120" value="{{ (string) $breakGlassTtlMinutes }}"
                   style="padding:10px 12px; border:1px solid #ccc; border-radius:10px; width:160px;" {!! $systemSettingsDisabled !!}>
            <button type="button" id="break_glass_qr_btn" class="ks-btn" style="display:none;" {!! $systemSettingsDisabled !!}>QR-Code anzeigen</button>
            <button type="button" id="noteinstieg_recovery_btn" class="ks-btn" style="display:none;" {!! $systemSettingsDisabled !!}>Notfallcodes anzeigen</button>
        </div>
        ...
        <input type="hidden" id="debug_break_glass_totp_secret" value="{{ $breakGlassTotpSecret }}" {!! $systemSettingsDisabled !!}>
        ...
        <script>
            (() => {
                ...
                const isProd = {{ $isProd ? 'true' : 'false' }};
                ...
                const saveAll = async () => {
                    ...
                    try {
                        await postJson(@json(route('admin.settings.save.ajax')), {
                        ...
                        await postJson(@json(route('admin.maintenance.eta.ajax')), {
                ...
                const loadCodes = async ({ clear = true, toast = true } = {}) => {
                    try {
                        ...
                        const out = await postJson(@json(route('admin.noteinstieg.recovery.list.ajax')), {});
                ...
                genBtn.addEventListener("click", async () => {
                    try {
                        ...
                        const out = await postJson(@json(route('admin.noteinstieg.recovery.generate.ajax')), {});
                        if (!out || out.ok !== true) {
