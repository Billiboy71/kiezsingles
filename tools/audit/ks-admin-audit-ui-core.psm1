# =============================================================================
# File: C:\laragon\www\kiezsingles\tools\audit\ks-admin-audit-ui-core.psm1
# Purpose: UI core module for KiezSingles Admin Audit Tool
# Created: 03-03-2026 12:00 (Europe/Berlin)
...
function Save-KsAuditUiSettings([string]$SettingsPath, [string]$ExportFolderValue, [string[]]$SecurityLockoutKeywordsValue = $null) {
    ...
    $existingKeywords = @("too many attempts","throttle","locked","lockout","zu viele","versuche")
    try {
...
function Show-AuditGui() {
    # Import caller-bound parameter/context variables into local scope to preserve UI behavior after module split.
    $callerVarNames = @(
        "BaseUrl","ProbePaths","HttpProbe","TailLog","TailLogMode","RoutesVerbose","RouteListFindstrAdmin",
        "SuperadminCount","LoginCsrfProbe","RoleSmokeTest","SuperadminEmail","SuperadminPassword","AdminEmail",
        "AdminPassword","ModeratorEmail","ModeratorPassword","RoleSmokePaths","PathsConfigFile","SessionCsrfBaseline",
        "LogSnapshot","LogSnapshotLines","LogClearBefore","LogClearAfter","SecurityProbe","SecurityLoginAttempts",
        "SecurityCheckIpBan","SecurityCheckRegister","SecurityExpect429","SecurityLockoutKeywords","SecurityE2E",
        "SecurityE2ELockout","SecurityE2EIpAutoban","SecurityE2EDeviceAutoban","SecurityE2EIdentityBan",
        "SecurityE2ESupportRef","SecurityE2EEventsCheck","SecurityE2EAttempts","SecurityE2EThreshold","SecurityE2ESeconds",
        "SecurityE2ELogin","SecurityE2EPassword","SecurityE2ECleanup","SecurityE2EDryRun","SecurityE2EEnvGate",
        "ShowCheckDetails","ExportLogs","ExportLogsLines","ExportFolder","AutoOpenExportFolder","PSBoundParameters"
    )
    foreach ($n in $callerVarNames) {
        try {
            $v = Get-Variable -Name $n -Scope 1 -ErrorAction Stop
            Set-Variable -Name $n -Value $v.Value -Scope Local
        } catch { }
    }
    if ($null -eq $PSBoundParameters) { $PSBoundParameters = @{} }
    ...
    # 12x) Security E2E (vollautomatisch)
    $lblSecurityE2E = New-Object System.Windows.Forms.Label
    $lblSecurityE2E.AutoSize = $true
    $lblSecurityE2E.Left = 10
    $lblSecurityE2E.Top = 1058
    $lblSecurityE2E.Text = "Security E2E Test (vollautomatisch)"
    $panelLeft.Controls.Add($lblSecurityE2E)

    $chkSecurityE2E = New-Object System.Windows.Forms.CheckBox
    $chkSecurityE2E.Left = 10
    $chkSecurityE2E.Top = 1078
    $chkSecurityE2E.Width = 340
    $chkSecurityE2E.Text = "SecurityE2E aktivieren"
    $chkSecurityE2E.Checked = [bool]$SecurityE2E
    $panelLeft.Controls.Add($chkSecurityE2E)

    $chkSecurityE2ELockout = New-Object System.Windows.Forms.CheckBox
    $chkSecurityE2ELockout.Left = 24
    $chkSecurityE2ELockout.Top = 1102
    $chkSecurityE2ELockout.Width = 326
    $chkSecurityE2ELockout.Text = "Lockout/Throttle Test"
    $chkSecurityE2ELockout.Checked = [bool]$SecurityE2ELockout
    $panelLeft.Controls.Add($chkSecurityE2ELockout)

    $chkSecurityE2EIpAutoban = New-Object System.Windows.Forms.CheckBox
    $chkSecurityE2EIpAutoban.Left = 24
    $chkSecurityE2EIpAutoban.Top = 1126
    $chkSecurityE2EIpAutoban.Width = 326
    $chkSecurityE2EIpAutoban.Text = "IP AutoBan Test"
    $chkSecurityE2EIpAutoban.Checked = [bool]$SecurityE2EIpAutoban
    $panelLeft.Controls.Add($chkSecurityE2EIpAutoban)

    $chkSecurityE2EDeviceAutoban = New-Object System.Windows.Forms.CheckBox
    $chkSecurityE2EDeviceAutoban.Left = 24
    $chkSecurityE2EDeviceAutoban.Top = 1150
    $chkSecurityE2EDeviceAutoban.Width = 326
    $chkSecurityE2EDeviceAutoban.Text = "Device AutoBan Test"
    $chkSecurityE2EDeviceAutoban.Checked = [bool]$SecurityE2EDeviceAutoban
    $panelLeft.Controls.Add($chkSecurityE2EDeviceAutoban)

    $chkSecurityE2EIdentityBan = New-Object System.Windows.Forms.CheckBox
    $chkSecurityE2EIdentityBan.Left = 24
    $chkSecurityE2EIdentityBan.Top = 1174
    $chkSecurityE2EIdentityBan.Width = 326
    $chkSecurityE2EIdentityBan.Text = "Identity Ban Test (optional)"
    $chkSecurityE2EIdentityBan.Checked = [bool]$SecurityE2EIdentityBan
    $panelLeft.Controls.Add($chkSecurityE2EIdentityBan)

    $chkSecurityE2ESupportRef = New-Object System.Windows.Forms.CheckBox
    $chkSecurityE2ESupportRef.Left = 24
    $chkSecurityE2ESupportRef.Top = 1198
    $chkSecurityE2ESupportRef.Width = 326
    $chkSecurityE2ESupportRef.Text = "SupportRef Anzeige Test (SEC-xxxx)"
    $chkSecurityE2ESupportRef.Checked = [bool]$SecurityE2ESupportRef
    $panelLeft.Controls.Add($chkSecurityE2ESupportRef)

    $chkSecurityE2EEventsCheck = New-Object System.Windows.Forms.CheckBox
    $chkSecurityE2EEventsCheck.Left = 24
    $chkSecurityE2EEventsCheck.Top = 1222
    $chkSecurityE2EEventsCheck.Width = 326
    $chkSecurityE2EEventsCheck.Text = "Events Check (security_events)"
    $chkSecurityE2EEventsCheck.Checked = [bool]$SecurityE2EEventsCheck
    $panelLeft.Controls.Add($chkSecurityE2EEventsCheck)

    $lblSecurityE2ELogin = New-Object System.Windows.Forms.Label
    $lblSecurityE2ELogin.AutoSize = $true
    $lblSecurityE2ELogin.Left = 10
    $lblSecurityE2ELogin.Top = 1248
    $lblSecurityE2ELogin.Text = "TestLoginIdentifier"
    $panelLeft.Controls.Add($lblSecurityE2ELogin)

    $txtSecurityE2ELogin = New-Object System.Windows.Forms.TextBox
    $txtSecurityE2ELogin.Left = 10
    $txtSecurityE2ELogin.Top = 1266
    $txtSecurityE2ELogin.Width = 340
    $txtSecurityE2ELogin.Text = ("" + $SecurityE2ELogin)
    $panelLeft.Controls.Add($txtSecurityE2ELogin)

    $lblSecurityE2EPassword = New-Object System.Windows.Forms.Label
    $lblSecurityE2EPassword.AutoSize = $true
    $lblSecurityE2EPassword.Left = 10
    $lblSecurityE2EPassword.Top = 1290
    $lblSecurityE2EPassword.Text = "WrongPassword"
    $panelLeft.Controls.Add($lblSecurityE2EPassword)

    $txtSecurityE2EPassword = New-Object System.Windows.Forms.TextBox
    $txtSecurityE2EPassword.Left = 10
    $txtSecurityE2EPassword.Top = 1308
    $txtSecurityE2EPassword.Width = 340
    $txtSecurityE2EPassword.UseSystemPasswordChar = $true
    $txtSecurityE2EPassword.Text = ("" + $SecurityE2EPassword)
    $panelLeft.Controls.Add($txtSecurityE2EPassword)

    $lblSecurityE2EAttempts = New-Object System.Windows.Forms.Label
    $lblSecurityE2EAttempts.AutoSize = $true
    $lblSecurityE2EAttempts.Left = 10
    $lblSecurityE2EAttempts.Top = 1334
    $lblSecurityE2EAttempts.Text = "Attempts"
    $panelLeft.Controls.Add($lblSecurityE2EAttempts)

    $numSecurityE2EAttempts = New-Object System.Windows.Forms.NumericUpDown
    $numSecurityE2EAttempts.Left = 70
    $numSecurityE2EAttempts.Top = 1330
    $numSecurityE2EAttempts.Width = 60
    $numSecurityE2EAttempts.Minimum = 1
    $numSecurityE2EAttempts.Maximum = 100
    $numSecurityE2EAttempts.Value = $(if ($SecurityE2EAttempts -ge 1 -and $SecurityE2EAttempts -le 100) { [decimal]$SecurityE2EAttempts } else { [decimal]10 })
    $panelLeft.Controls.Add($numSecurityE2EAttempts)

    $lblSecurityE2EThreshold = New-Object System.Windows.Forms.Label
    $lblSecurityE2EThreshold.AutoSize = $true
    $lblSecurityE2EThreshold.Left = 140
    $lblSecurityE2EThreshold.Top = 1334
    $lblSecurityE2EThreshold.Text = "Threshold"
    $panelLeft.Controls.Add($lblSecurityE2EThreshold)

    $numSecurityE2EThreshold = New-Object System.Windows.Forms.NumericUpDown
    $numSecurityE2EThreshold.Left = 210
    $numSecurityE2EThreshold.Top = 1330
    $numSecurityE2EThreshold.Width = 60
    $numSecurityE2EThreshold.Minimum = 1
    $numSecurityE2EThreshold.Maximum = 100
    $numSecurityE2EThreshold.Value = $(if ($SecurityE2EThreshold -ge 1 -and $SecurityE2EThreshold -le 100) { [decimal]$SecurityE2EThreshold } else { [decimal]3 })
    $panelLeft.Controls.Add($numSecurityE2EThreshold)

    $lblSecurityE2ESeconds = New-Object System.Windows.Forms.Label
    $lblSecurityE2ESeconds.AutoSize = $true
    $lblSecurityE2ESeconds.Left = 278
    $lblSecurityE2ESeconds.Top = 1334
    $lblSecurityE2ESeconds.Text = "Seconds"
    $panelLeft.Controls.Add($lblSecurityE2ESeconds)

    $numSecurityE2ESeconds = New-Object System.Windows.Forms.NumericUpDown
    $numSecurityE2ESeconds.Left = 278
    $numSecurityE2ESeconds.Top = 1352
    $numSecurityE2ESeconds.Width = 72
    $numSecurityE2ESeconds.Minimum = 1
    $numSecurityE2ESeconds.Maximum = 86400
    $numSecurityE2ESeconds.Value = $(if ($SecurityE2ESeconds -ge 1 -and $SecurityE2ESeconds -le 86400) { [decimal]$SecurityE2ESeconds } else { [decimal]300 })
    $panelLeft.Controls.Add($numSecurityE2ESeconds)

    $chkSecurityE2ECleanup = New-Object System.Windows.Forms.CheckBox
    $chkSecurityE2ECleanup.Left = 10
    $chkSecurityE2ECleanup.Top = 1378
    $chkSecurityE2ECleanup.Width = 170
    $chkSecurityE2ECleanup.Text = "Cleanup nach Test"
    $chkSecurityE2ECleanup.Checked = [bool]$SecurityE2ECleanup
    $panelLeft.Controls.Add($chkSecurityE2ECleanup)

    $chkSecurityE2EDryRun = New-Object System.Windows.Forms.CheckBox
    $chkSecurityE2EDryRun.Left = 184
    $chkSecurityE2EDryRun.Top = 1378
    $chkSecurityE2EDryRun.Width = 80
    $chkSecurityE2EDryRun.Text = "DryRun"
    $chkSecurityE2EDryRun.Checked = [bool]$SecurityE2EDryRun
    $panelLeft.Controls.Add($chkSecurityE2EDryRun)

    $chkSecurityE2EEnvGate = New-Object System.Windows.Forms.CheckBox
    $chkSecurityE2EEnvGate.Left = 10
    $chkSecurityE2EEnvGate.Top = 1402
    $chkSecurityE2EEnvGate.Width = 340
    $chkSecurityE2EEnvGate.Text = "Nur in local/dev erlauben (BaseUrl/ENV Gate)"
    $chkSecurityE2EEnvGate.Checked = [bool]$SecurityE2EEnvGate
    $panelLeft.Controls.Add($chkSecurityE2EEnvGate)

    $detailsMasterTop = 1424
    $globalBlockTop = 1424
    ...
    try {
        ...
        $toolTip.SetToolTip($chkSecurityE2E, "Aktiviert den vollautomatischen Security-E2E-Check.")
        $toolTip.SetToolTip($chkSecurityE2ELockout, "Prueft Lockout/Throttle-Erkennung ueber wiederholte Login-Fails.")
        $toolTip.SetToolTip($chkSecurityE2EIpAutoban, "Prueft temporaeren IP-AutoBan im E2E-Flow.")
        $toolTip.SetToolTip($chkSecurityE2EDeviceAutoban, "Prueft temporaeren Device-AutoBan im E2E-Flow.")
        $toolTip.SetToolTip($chkSecurityE2EIdentityBan, "Optionaler Identity-Ban-Teiltest, nur wenn serverseitig ohne DB-Manipulation moeglich.")
        $toolTip.SetToolTip($chkSecurityE2ESupportRef, "Prueft SEC-xxxx SupportRef im Login-Banner.")
        $toolTip.SetToolTip($chkSecurityE2EEventsCheck, "Prueft erwartete Security-Events fuer den E2E-Run.")
        $toolTip.SetToolTip($txtSecurityE2ELogin, "Test-Login-Identifier (E-Mail oder Username).")
        $toolTip.SetToolTip($txtSecurityE2EPassword, "Falsches Passwort fuer wiederholte Login-Fails.")
        $toolTip.SetToolTip($numSecurityE2EAttempts, "Anzahl E2E-Login-Versuche.")
        $toolTip.SetToolTip($numSecurityE2EThreshold, "Temporarer AutoBan-Fail-Threshold fuer den Testlauf.")
        $toolTip.SetToolTip($numSecurityE2ESeconds, "Temporare AutoBan-Dauer in Sekunden fuer den Testlauf.")
        $toolTip.SetToolTip($chkSecurityE2ECleanup, "Ruecksetzen/Entfernen der im Test erzeugten Artefakte.")
        $toolTip.SetToolTip($chkSecurityE2EDryRun, "Nur lesen/pruefen, keine mutierenden Testaktionen.")
        $toolTip.SetToolTip($chkSecurityE2EEnvGate, "Schuetzt vor Ausfuehrung ausserhalb local/dev.")
    ...
    function Sync-SecurityE2EFieldsEnabled() {
        $on = [bool]$chkSecurityE2E.Checked
        $chkSecurityE2ELockout.Enabled = $on
        $chkSecurityE2EIpAutoban.Enabled = $on
        $chkSecurityE2EDeviceAutoban.Enabled = $on
        $chkSecurityE2EIdentityBan.Enabled = $on
        $chkSecurityE2ESupportRef.Enabled = $on
        $chkSecurityE2EEventsCheck.Enabled = $on
        $lblSecurityE2ELogin.Enabled = $on
        $txtSecurityE2ELogin.Enabled = $on
        $lblSecurityE2EPassword.Enabled = $on
        $txtSecurityE2EPassword.Enabled = $on
        $lblSecurityE2EAttempts.Enabled = $on
        $numSecurityE2EAttempts.Enabled = $on
        $lblSecurityE2EThreshold.Enabled = $on
        $numSecurityE2EThreshold.Enabled = $on
        $lblSecurityE2ESeconds.Enabled = $on
        $numSecurityE2ESeconds.Enabled = $on
        $chkSecurityE2ECleanup.Enabled = $on
        $chkSecurityE2EDryRun.Enabled = $on
        $chkSecurityE2EEnvGate.Enabled = $on
    }
    ...
    $chkSecurityE2E.add_CheckedChanged({ Sync-SecurityE2EFieldsEnabled })
    Sync-SecurityE2EFieldsEnabled
    ...
    function Get-UiArgs() {
        ...
        if ($chkSecurityProbe.Checked -and $chkSecurityCheckIpBan.Checked) { $argsList.Add("-SecurityCheckIpBan") | Out-Null }
        if ($chkSecurityProbe.Checked -and $chkSecurityCheckRegister.Checked) { $argsList.Add("-SecurityCheckRegister") | Out-Null }
        if ($chkSecurityProbe.Checked -and $chkSecurityExpect429.Checked) { $argsList.Add("-SecurityExpect429") | Out-Null }
        $securityAttemptsUi = 8
        try { $securityAttemptsUi = [int]$numSecurityAttempts.Value } catch { $securityAttemptsUi = 8 }
        if ($securityAttemptsUi -lt 1) { $securityAttemptsUi = 1 }
        if ($securityAttemptsUi -gt 10) { $securityAttemptsUi = 10 }
        ...
        if ($chkSecurityE2E.Checked) { $argsList.Add("-SecurityE2E") | Out-Null }
        if ($chkSecurityE2E.Checked -and $chkSecurityE2ELockout.Checked) { $argsList.Add("-SecurityE2ELockout") | Out-Null }
        if ($chkSecurityE2E.Checked -and $chkSecurityE2EIpAutoban.Checked) { $argsList.Add("-SecurityE2EIpAutoban") | Out-Null }
        if ($chkSecurityE2E.Checked -and $chkSecurityE2EDeviceAutoban.Checked) { $argsList.Add("-SecurityE2EDeviceAutoban") | Out-Null }
        if ($chkSecurityE2E.Checked -and $chkSecurityE2EIdentityBan.Checked) { $argsList.Add("-SecurityE2EIdentityBan") | Out-Null }
        if ($chkSecurityE2E.Checked -and $chkSecurityE2ESupportRef.Checked) { $argsList.Add("-SecurityE2ESupportRef") | Out-Null }
        if ($chkSecurityE2E.Checked -and $chkSecurityE2EEventsCheck.Checked) { $argsList.Add("-SecurityE2EEventsCheck") | Out-Null }

        $securityE2EAttemptsUi = 10
        try { $securityE2EAttemptsUi = [int]$numSecurityE2EAttempts.Value } catch { $securityE2EAttemptsUi = 10 }
        if ($chkSecurityE2E.Checked -and $securityE2EAttemptsUi -gt 0) {
            $argsList.Add("-SecurityE2EAttempts") | Out-Null
            $argsList.Add(("" + $securityE2EAttemptsUi)) | Out-Null
        }

        $securityE2EThresholdUi = 3
        try { $securityE2EThresholdUi = [int]$numSecurityE2EThreshold.Value } catch { $securityE2EThresholdUi = 3 }
        if ($chkSecurityE2E.Checked -and $securityE2EThresholdUi -gt 0) {
            $argsList.Add("-SecurityE2EThreshold") | Out-Null
            $argsList.Add(("" + $securityE2EThresholdUi)) | Out-Null
        }

        $securityE2ESecondsUi = 300
        try { $securityE2ESecondsUi = [int]$numSecurityE2ESeconds.Value } catch { $securityE2ESecondsUi = 300 }
        if ($chkSecurityE2E.Checked -and $securityE2ESecondsUi -gt 0) {
            $argsList.Add("-SecurityE2ESeconds") | Out-Null
            $argsList.Add(("" + $securityE2ESecondsUi)) | Out-Null
        }

        $securityE2ELoginUi = ""
        try { $securityE2ELoginUi = ("" + $txtSecurityE2ELogin.Text).Trim() } catch { $securityE2ELoginUi = "" }
        if ($chkSecurityE2E.Checked -and $securityE2ELoginUi -ne "") {
            $argsList.Add("-SecurityE2ELogin") | Out-Null
            $argsList.Add($securityE2ELoginUi) | Out-Null
        }

        $securityE2EPasswordUi = ""
        try { $securityE2EPasswordUi = ("" + $txtSecurityE2EPassword.Text) } catch { $securityE2EPasswordUi = "" }
        if ($chkSecurityE2E.Checked -and $securityE2EPasswordUi -ne "") {
            $argsList.Add("-SecurityE2EPassword") | Out-Null
            $argsList.Add($securityE2EPasswordUi) | Out-Null
        }

        if ($chkSecurityE2E.Checked) {
            $argsList.Add("-SecurityE2ECleanup") | Out-Null
            $argsList.Add(("" + [bool]$chkSecurityE2ECleanup.Checked).ToLowerInvariant()) | Out-Null
        }

        if ($chkSecurityE2E.Checked) {
            $argsList.Add("-SecurityE2EDryRun") | Out-Null
            $argsList.Add(("" + [bool]$chkSecurityE2EDryRun.Checked).ToLowerInvariant()) | Out-Null
        }

        if ($chkSecurityE2E.Checked) {
            $argsList.Add("-SecurityE2EEnvGate") | Out-Null
            $argsList.Add(("" + [bool]$chkSecurityE2EEnvGate.Checked).ToLowerInvariant()) | Out-Null
        }
        ...
        $activeChecksMap = [ordered]@{
            "http_probe" = [bool]$chkHttpProbe.Checked
            "login_csrf_probe" = [bool]$chkLoginCsrfProbe.Checked
            "role_smoke_test" = [bool]$chkRoleSmokeTest.Checked
            "governance_superadmin" = [bool]$chkSuperadminCount.Checked
            "session_csrf_baseline" = [bool]$chkSessionCsrfBaseline.Checked
            "security_abuse" = [bool]$chkSecurityProbe.Checked
            "security_e2e" = [bool]$chkSecurityE2E.Checked
            "routes_verbose" = [bool]$chkRoutesVerbose.Checked
            "routes_findstr_admin" = [bool]$chkRouteListFindstrAdmin.Checked
            "log_snapshot" = [bool]($snapshotSelection -ne "OFF")
            "tail_log" = [bool]$chkTailLog.Checked
            "log_clear_before" = [bool]$chkLogClearBefore.Checked
            "log_clear_after" = [bool]$chkLogClearAfter.Checked
        }

        if ([bool]$chkShowCheckDetails.Checked) {
            foreach ($k in @($activeChecksMap.Keys)) {
                if ([bool]$activeChecksMap[$k]) { $perCheckDetailsMap[$k] = $true }
            }
        }

        if ([bool]$chkExportLogs.Checked) {
            foreach ($k in @($activeChecksMap.Keys)) {
                if ([bool]$activeChecksMap[$k]) { $perCheckExportMap[$k] = $true }
            }
        }
    ...
    $btnSaveSecurityKeywords.Add_Click({
        try {
            ...
            if ($kw.Count -le 0) { $kw = @("too many attempts","throttle","locked","lockout","zu viele","versuche") }
...
Export-ModuleMember -Function Write-Section,Confirm-ProjectRoot,Normalize-BaseUrl,Resolve-ExportFolderAbsolute,ConvertTo-NormalizedText,Invoke-ProcessToFiles,Write-StdStreams,ConvertTo-QuotedArg,Get-MaskedArgumentList,Get-KsAuditPathsConfig,Save-KsAuditPathsConfig,Get-KsAuditCredentialsConfig,Save-KsAuditCredential,Get-KsAuditUiSettings,Save-KsAuditUiSettings,Set-RoundButtonShape,Start-LaravelTailWindow,Show-AuditGui
